...
namespace FilesApp.Migrations
{
    ...
    [Migration("20241023191820_CreateSharedLink")]
    partial class CreateSharedLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilesApp.Models.DAL.AppUser", b =>
                {
            ...
            modelBuilder.Entity("FilesApp.Models.DAL.SharedLink", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FilesApp.Models.DAL.AppUser", null)
                        .WithMany()
